...
namespace DevIO.Api.V1.Controllers
{
    ...
    public class FornecedoresController : MainController
    {
        ...
        //1. In package manager console, run: Install-Package Microsoft.AspNetCore.Mvc.NewtonsoftJson -Version 3.0.0-preview8.19405.7
        //2. Add in Startup services.AddControllers().AddNewtonsoftJson(); - you will receive an error, AddNewtonsoftJson() not recognized.
